...
function placeXOro(squareNumber) {
    //This conditions ensures a square hasn't be selected already.
    //The .some() methos is used to check each element od selectedSquare arrat to see if it contains the square number clicked on.
    if (!selectedSquares .some(element => element.includes(squareNumber))) {
        ...
        //Active player may onlybe 'X' or 'O' so, if not 'X' it must be 'O'
        } else {
            //If activePlayeris equal to 'O', the o.png is placed in HTML.
            select.style.backgroundImage = 'url("./images/o.png")';
        }
        //squareNumber and activePlayer are contenated together and added to array.
        selectedSquares.push(squareNumber + activePlayer);
        //This calls a function to check for any win conditions.
        checkWinConditions() ;
        //This conditions is for changing the active player.
        if (activePlayer === 'X') {
            //If active player is 'X' change it to 'X'.
            activePlayer = 'O';
        //If active player is anything other than 'O'.
        } else {
        ...
        if(activePlayer === 'O') {
            ...
            disableClick();
            //This function wait 1 second before placing the image and enabling click.
...
//This function takes a string parameter of the path you set earlier for placement sound ('./media/placeIcon.mp3')
function audio(audioURL) {
    //We create a new audio object and we paass the path as a parameter.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        c.moveTo(x1, y1);
        //This methiod indicates the end point in our line
        c.lineTo(x, y);
...
//This function resets the game in the tie or a win.
function resetGame() {
    ...
    //This reaction our array so it is empty and we can start over.
    selectedSquares = [];
}